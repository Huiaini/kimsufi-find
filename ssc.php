...
<body>
    <audio preload loop id="clock">
        <source src="https://coding.net/u/jocry/p/kimsufi-find/git/raw/master/1.ogg" type="audio/ogg">
        <source src="https://coding.net/u/jocry/p/kimsufi-find/git/raw/master/1.mp3" type="audio/mpeg">
    </audio>
    <header>
        <h2>库存状态监控</h2>
        <div class='menu'>
